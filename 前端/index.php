				...
				<div class="card border-0 mt-5">
					<?php if( isset($status) && $status == 'success' ):  ?>
						...
						<div class="card-body px-5 pb-5">
							<h2 class="text-uppercase text-center">缩短后的网址</h2>
							...
							<div class="row justify-content-center">
								<div class="col-10">
									...
									<span class="info">查看网址的信息与统计：<a href="<?php echo $shorturl; ?>+"><?php echo $url; ?>+</a></span>
								</div>
							</div>
						</div>
					<?php else: ?>
						...
						<div class="card-body px-md-5">
							...
							<form id="shortenlink" method="post" action="">
								<div class="input-group input-group-block mt-4 mb-3">
									<input type="url" name="url" id="url" class="form-control text-uppercase" placeholder="粘贴您的长链接" aria-label="粘贴您的长链接" aria-describedby="shorten-button" required>
								...
								<?php if (enableCustomURL): ?>
									<a class="btn btn-sm btn-white text-black-50 text-uppercase" data-bs-toggle="collapse" href="#customise-link" role="button" aria-expanded="false" aria-controls="customise-link">
										<img src="<?php echo YOURLS_SITE ?>/frontend/assets/svg/custom-url.svg" alt="Options"> 自定义选项
									</a>
									<div class="collapse" id="customise-link">
										<div class="mt-2 card card-body">
											<div class="d-flex  align-items-center">
												<span class="me-2"><?php echo preg_replace("(^https?://)", "", YOURLS_SITE ); ?>/</span>
												<input type="text" name="keyword" class="form-control form-control-sm text-uppercase" placeholder="自定义别名" aria-label="自定义别名">
											</div>
										</div>
									</div>
								<?php endif; ?>
